class AddQuantityToLineItemsController < ApplicationController
  before_action :set_add_quantity_to_line_item, only: [:show, :edit, :update, :destroy]

  # GET /add_quantity_to_line_items
  # GET /add_quantity_to_line_items.json
  def index
    @add_quantity_to_line_items = AddQuantityToLineItem.all
  end

  # GET /add_quantity_to_line_items/1
  # GET /add_quantity_to_line_items/1.json
  def show
  end
  ...
  # POST /add_quantity_to_line_items
  # POST /add_quantity_to_line_items.json
  def create
    ...
    respond_to do |format|
      if @add_quantity_to_line_item.save
        format.html { redirect_to @add_quantity_to_line_item, notice: 'Add quantity to line item was successfully created.' }
  ...
  # PATCH/PUT /add_quantity_to_line_items/1
  # PATCH/PUT /add_quantity_to_line_items/1.json
  def update
    respond_to do |format|
      if @add_quantity_to_line_item.update(add_quantity_to_line_item_params)
        format.html { redirect_to @add_quantity_to_line_item, notice: 'Add quantity to line item was successfully updated.' }
  ...
  # DELETE /add_quantity_to_line_items/1
  # DELETE /add_quantity_to_line_items/1.json
  def destroy
